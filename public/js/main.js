...
ReactDOM.render(React.createElement(ListManager, { title: 'Car' }), document.getElementById('car'));

ReactDOM.render(React.createElement(ListManager, { title: 'Home', headingColor: '#00ff00' }), document.getElementById('home'));
